...
The homogeneity decomposition lemma is what justifies applying the
kill move at sub-amplitude level (otherwise we couldn't equate
weight-components or reduce coefficients independently). The
d-subset uniqueness lemma is a separate rewrite of Rodina's argument
supporting the unitarity track, independent of the locality kill
mechanism.
