...
| [`step4_laurent_block_analysis/`](step4_laurent_block_analysis/) | §6 + §7. Block-rule Laurent kill (n=8, n=9) | Does the depth-1 cascade rule extend? (n=8: 100/100 singletons. n=9: 94/113 singletons + 4 failures, but the 90-orbit cluster has rank 90 / nullity 0 — block-rule kills jointly.) Also includes three n=9 cluster visualization galleries — full 90-orbit gallery, D_9-reflection reduction (90 → 55 groups), and a row-structure / equation-symmetry analysis showing the system is Z_9-invariant but breaks D_9. |
